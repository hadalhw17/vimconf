...
syn keyword fxType		min16float min16float2 min16float3 min16float4
...
syn keyword fxAnnotation	Space UIDesc UIName UIObject UIType UIMin UIMax UIStep UIWidget
...
syn keyword fxProgram		VertexShader PixelShader ComputeShader DomainShader GeometryShader
